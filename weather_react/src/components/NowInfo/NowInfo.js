...
function NowInfo() {
  return (
    <div className="info-weather__item now-info-weather">
      <div className="now-info-weather__temperature _deg">17</div>
      <div className="now-info-weather__icon">
        <img src="https://openweathermap.org/img/wn/04n@4x.png" alt="Icon Weather" />
      </div>
      <div className="now-info-weather__info">
        <div className="now-info-weather__town">Cape Town</div>
        <button type="button" className="now-info-weather__like"> {/* active */}
