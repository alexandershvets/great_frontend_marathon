...
async function formSettingsHundler(event) {
    ...
    const response = await _network.network.getUserData(_cookie.cookies.get(_cookie.cookies.names.token));
    _cookie.cookies.set(_cookie.cookies.names.email, response.email);
    _cookie.cookies.set(_cookie.cookies.names.userName, response.name);
...
},{"../scss/main.scss":"kOw5V","./network":"8wofE","./cookie":"lfQWm","./data":"4vWRQ","./view":"kALtk","./popup":"jUySk","./error":"iq6dU"}],"kOw5V":[function() {},{}],"8wofE":[function(require,module,exports) {
