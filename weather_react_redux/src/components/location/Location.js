...
import { weatherChangeCurrentCity, favoriteRemoveCity } from '../../actions';
  ...
  return (
    <li className="locations-weather__item location-weather">
      <button
        ...
        onClick={() => dispatch( weatherChangeCurrentCity(cityName) )}
      >
        {cityName}
      </button>
      <button
        ...
        onClick={() => dispatch( favoriteRemoveCity(cityName) )}
      >
